---
name: pi-context
description: Optimize pi project context using prompts. Use when prompts are too long, cluttered, or poorly organized. Triggers on: "optimize prompts", "context budget", "what should pi know", or any concern about project context.
---
...
description: Testing
---
We use Jest for testing. Tests are located in __tests__/ directories
next to source files. Test files should be named with the .test.ts
extension. Use describe and it blocks for organizing tests.
```
...
---
Run tests: `npm test`. Single file: `npm test -- --testPathPattern=<file>`.
Tests co-located in __tests__/ with source.
```
...
Avoid: `testing-guide.md` → `test.md`
Avoid: `how-to-run-tests.md` → `test.md`
